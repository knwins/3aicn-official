...
t=outlookbar.addtitle('·中文版管理·')
outlookbar.additem('<br>分类管理',t,'Product_Cate_List.asp?ver=cn')
outlookbar.additem('<br>产品管理',t,'Product_List.asp?ver=cn')
outlookbar.additem('<br>信息分类管理',t,'NewsCate_List.asp?ver=cn')
outlookbar.additem('<br>信息管理',t,'News_list.asp?ver=cn')
outlookbar.additem('<br>首页幻灯片',t,'banner_list.asp?ver=cn')
outlookbar.additem('<br>企业信息',t,'company.asp?ver=cn')
outlookbar.additem('<br>网站参数',t,'site.asp?id=1')
outlookbar.additem('<br>生成',t,'create_html.asp')
<%
end if
if instr(1,rs("quanxian"),",1,")>0 then
%>

t=outlookbar.addtitle('·英文版管理·')
outlookbar.additem('<br>分类管理',t,'Product_Cate_List.asp?ver=en')
outlookbar.additem('<br>产品管理',t,'Product_List.asp?ver=en')
outlookbar.additem('<br>信息分类管理',t,'NewsCate_List.asp?ver=en')
outlookbar.additem('<br>信息管理',t,'News_list.asp?ver=en')
outlookbar.additem('<br>首页幻灯片',t,'banner_list.asp?ver=en')
outlookbar.additem('<br>企业信息',t,'company.asp?ver=en')
outlookbar.additem('<br>网站参数',t,'site.asp?id=2')
outlookbar.additem('<br>生成',t,'create_en_html.asp')
<%
end if
if instr(1,rs("quanxian"),",3,")>0 then
%>
t=outlookbar.addtitle('·权限管理·')
outlookbar.additem('<br>管理员管理',t,'quanxian.asp?pid=1')

<%
end if
%>
t=outlookbar.addtitle('·系统管理·')
outlookbar.additem('<br>修改密码',t,'modipass.asp')
outlookbar.additem('<br>退出系统',t,'logout.asp')
</SCRIPT>
...
outlookbar.show()	
    ...
    <td width="16" bgcolor=#FFFFFF background="images/menu_bg_02.gif"> 
      <table cellspacing=0 cellpadding=0 border=0>
        <tr> 
          <td valign=center align=middle> <span class=np id=switchPoint onClick=switchSysBar() title="打开/关闭导航">3</span></td>
        </tr>
      </table>
    </td>
  </tr>
